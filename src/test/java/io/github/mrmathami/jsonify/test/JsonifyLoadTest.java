...
public class JsonifyLoadTest {
	...
	public void loadArrayEmpty() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[]"));
	...
	public void loadArrayNull() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[null]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayFalse() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[false]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayTrue() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[true]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayNumber() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[0]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayDouble() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[null,null]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayTriple() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("[null,null,null]"));
			Assertions.assertEquals(JsonArray.class, element.getClass());
	...
	public void loadArrayWhitespace() throws IOException {
		try {
			...
			final JsonElement element = JsonLoader.load(new StringReader(input));
			Assertions.assertEquals(JsonArray.class, element.getClass());
			Assertions.assertEquals(List.of(JsonKeyword.NULL, JsonKeyword.NULL, JsonKeyword.NULL), element);
		} catch (final JsonException e) {
			Assertions.fail(e);
	...
	public void throwArrayNoClose() {
		Assertions.assertThrows(JsonException.class, () -> JsonLoader.load(new StringReader("[")));
	}
	...
	public void throwArrayExtraSingleInside() {
		Assertions.assertThrows(JsonException.class, () -> JsonLoader.load(new StringReader("[null,]")));
	}
	...
	public void loadObjectDouble() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("{\"\":null,\"2\":null}"));
			Assertions.assertEquals(JsonObject.class, element.getClass());
	...
	public void loadObjectTriple() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("{\"\":null,\"2\":null,\"3\":null}"));
			Assertions.assertEquals(JsonObject.class, element.getClass());
	...
	public void throwTrueExtra() {
		Assertions.assertThrows(JsonException.class, () -> JsonLoader.load(new StringReader("true,")));
	}

	@Test
	public void throwFalseExtra() {
		Assertions.assertThrows(JsonException.class, () -> JsonLoader.load(new StringReader("false,")));
	}
	...
	public void loadNumberIntegerBig() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("123456789012345678901234567890"));
	...
	public void loadNumberDecimalFractionSmall() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("0.12345678"));
	...
	public void loadNumberDecimalFractionMedium() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("0.12345678912345678"));
	...
	public void loadNumberDecimalFractionBig() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("0.123456789012345678901234567890"));
	...
	public void loadNumberDecimalFractionTrailingZero() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("0.1000"));
	...
	public void loadNumberDecimalFractionExponent() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("1.0e9"));
	...
	public void loadNumberDecimalFractionTrailingZeroExponent() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("1.0000e9"));
	...
	public void loadNumberDecimalExponent() throws IOException {
		try {
			final JsonElement element = JsonLoader.load(new StringReader("1e9"));
	...
	public void throwNumberExtra() {
		Assertions.assertThrows(JsonException.class, () -> JsonLoader.load(new StringReader("0,")));
	}
}
